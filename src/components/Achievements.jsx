...
const Achievements = () => {
  ...
  const maxIndex = achievementsData.length - visibleCards;
  ...
  return (
    <div
      id="achievements"
      className="pt-24 pb-20 min-h-screen w-full flex flex-col items-center gap-14 px-4 md:px-14">
    ...
    <ScrollReveal>
      <div className="relative w-full max-w-[1100px] overflow-hidden">
        {/* Arrows */}
        <button onClick={prev} className="absolute left-2 top-1/2 z-10 -translate-y-1/2 bg-black/70 p-2 rounded-full text-white">
          <BiChevronLeft size={28} />
        </button>

        <button onClick={next} className="absolute right-2 top-1/2 z-10 -translate-y-1/2 bg-black/70 p-2 rounded-full text-white">
